...
void initBabyBugEyedMonster(Entity *e)
{
	Monster *m;
	...
	if (textures[0] == NULL)
	{
		textures[0] = getAtlasImage("gfx/entities/babyBugEyedMonster1.png", 1);
		textures[1] = getAtlasImage("gfx/entities/babyBugEyedMonster2.png", 1);
	}

	e->typeName = "babyBugEyedMonster";
