...
#include "greenTentacleMonster.h"
...
void initGreenTentacleMonster(Entity *e)
{
	Monster *m;
	...
	if (textures[0] == NULL)
	{
		textures[0] = getAtlasImage("gfx/entities/greenTentacleMonster1.png", 1);
		textures[1] = getAtlasImage("gfx/entities/greenTentacleMonster2.png", 1);
	}

	e->typeName = "greenTentacleMonster";
