...
static void loadConfigFile(const char *filename)
{
	...
	app.config.keyControls[CONTROL_MAP] = cJSON_GetObjectItem(controls, "map")->valueint;
	...
	app.config.joypadControls[CONTROL_MAP] = cJSON_GetObjectItem(controls, "map")->valueint;
...
void saveConfig(void)
{
	...
	cJSON_AddNumberToObject(controlsJSON, "map", app.config.keyControls[CONTROL_MAP]);
	...
	cJSON_AddNumberToObject(controlsJSON, "map", app.config.joypadControls[CONTROL_MAP]);
